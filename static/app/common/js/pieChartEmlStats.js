...
var pieChartEmlStats = {
    _renderChart: function(chartSelector, sizeW, sizeH, sendCount, openCount, clickCount) {
    ...
    _getSendCount: function(obj, callback){
        this._statsApiRequest('send', obj, callback);
    },
    _getOpenCount: function(obj, callback){
        this._statsApiRequest('open', obj, callback);
    },
    _getClickCount: function(obj, callback){
        this._statsApiRequest('click', obj, callback);
    },
    _statsApiRequest: function(table, obj, callback){
        var tables = {
            send: 'eml_send',
            open: 'eml_open',
            click: 'eml_click'
    ...
    makeChart: function (chartSelector, sizeW, sizeH, sendId) {
