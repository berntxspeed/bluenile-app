...
class Purchase(user_db.Model):
    ...
    created_at = user_db.Column(TIMESTAMP)
    updated_at = user_db.Column(TIMESTAMP)
...
class Report(user_db.Model):
    ...
    aggregate_op_2 = user_db.Column(user_db.String(255))
    aggregate_field_2 = user_db.Column(user_db.String(255))
    math_op = user_db.Column(user_db.String(255))
